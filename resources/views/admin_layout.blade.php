...
<link rel="stylesheet" href="public/backend/admin/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="public/backend/admin/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="public/backend/admin/js/jquery2.0.3.min.js"></script>
<script src="public/backend/admin/js/raphael-min.js"></script>
<script src="public/backend/admin/js/morris.js"></script>
</head>
<body>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="public/backend/admin/img/2.png">
                <span class="username">
                <?php 
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('admin_logout')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="public/backend/admin/grids.html">Khác</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2020 <a href="http://fb.me/thanh.dz.az">Admin</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<!-- calendar -->
	<script type="text/javascript" src="public/backend/admin/js/monthly.js"></script>
